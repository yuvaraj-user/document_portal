					...
					<div class="row">
						<div class="col-sm-6">
							<div class="page-title-box">
								<h4>QC field observation report</h4>
							</div>
						</div>
					</div>
				                    ...
				                    <div class="card-body">
				             			...
				             			<div class="row">
				             				...
				             				<div class="col-md-2 pe-0">
												...
												<input type="date" class="form-control from_date" name="location_date" id="from_date" value="2017-01-01" />
											</div>
											

				             				<div class="col-md-2 ps-0">
												<label for="to_date" class="form-label">To Date</label>
												<input type="date" class="form-control to_date" name="location_date" id="to_date" value="<?= date('Y-m-d'); ?>"/>
											</div>
											...
											<div class="col-md-2">
												...
												<select class="form-select SeasonCode select2" id="SeasonCode" name="SeasonCode" required>
													...
													<option value="18KW" selected>18KW</option>
											...
											<div class="col-md-2">
												...
												<select class="form-select Plant select2" id="Plant" name="Plant" required>
													...
													<option value="P009" selected>P009</option>
											...
											<div class="col-md-2">
												...
												<select class="form-select CropCode select2" id="CropCode" name="CropCode" required>
													...
													<option value="014" selected>014</option>
											...
											<div class="col-md-2">
												...
												<select class="form-select Yearcode select2" id="Yearcode" name="Yearcode" required>
													...
													<option value="PR18" selected>PR18</option>
												
												</select>
											</div>

											<div class="col-md-1 mt-2 ms-auto">
												<br>
		  ...
		  <div class="modal-dialog modal-dialog-centered modal-lg">
		    <div class="modal-content">
		      <div class="modal-header bg-info">
		        <h5 class="modal-title text-white img_head_title" id="exampleModalLabel">Image</h5>
		        <button type="button" class="close text-white" data-bs-dismiss="modal" aria-label="Close">
		          <span aria-hidden="true">&times;</span>
		        </button>
		      </div>
		      <div class="modal-body" id="mobile_popup_modal">
...
<script>
	...
	$(document).ready(function(){
	    ...
	    // 	});
		 ...
		 user_input.from_date = $('.from_date').val();
		 user_input.to_date   = $('.to_date').val();
	                 ...
	                 if ( this.context.length ) {
	                     var jsonResult = $.ajax({
	                        ...
	                        "url": "Common_Ajax.php", 
	                         type:'POST',
	                         dataType:'json',
	                         "data": {Action:"QC_Product_report",length:"All",user_input : user_input},
	                         async: false,
	                     });
	...
	$(document).on('click','.mobile-image',function(){
		var image_path = $(this).closest('td').find('#img').val();

		// if(image_path.includes('http://192.168.162.213:8081/')) {
		// 	image_path = image_path.replace('http://192.168.162.213:8081/','http://192.168.162.213:8081/');
		// }

		var html =  `<div class="row">
		        	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
		        		<img src="file_server.php?image=${image_path}" style="width: 100%;height: 500px;">
		        	</div>
		        </div>`;
		$('#mobile_popup_modal').html(html);
		$('.img_head_title').text('Image');
